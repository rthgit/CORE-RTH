...
CORE RTH is a runtime designed to coordinate **multiple LLMs, tools, and real-world systems**
(IoT, robotics, messaging, and automation) through a governed execution model with **security, policy enforcement, and full auditability**.
...
Commercial licensing: **[info@rthitalia.com](mailto:info@rthitalia.com)**
See: [`LICENSE`](LICENSE)
...
* **[`app/core/`](app/core/)**: The brainstem. Houses `jarvis_core.py`, `security_vault.py`, `prompt_system.py`, and `cortex_vision.py`.
* **[`app/api/`](app/api/)**: The FastAPI neuromuscular junction communicating telemetry to the frontend and receiving omni-channel webhooks.
* **[`app/ui_control_plane.html`](app/ui_control_plane.html)** / js: The Mission Control dashboard offering an exquisite zero-friction UI, Policy Ledger, and E-Stop capabilities.
* **[`scripts/`](scripts/)**: The command-line arsenal for deployment, headless operation, and auditing.
...
* 🏗️ **[Architecture Guide](ARCHITECTURE.md)** - Deep dive into `jarvis_core.py`, the AI Village, and the code tools.
